...
```{r, echo=FALSE}
## source("~/Desktop/Stat 345/Projects/Midterm/NBACourtFunction.R")
...
Also: All the code can also be called from an additional R script that I made:

```{r, echo=FALSE}
source("~/R Scripts/Shot Charts.R")
```
